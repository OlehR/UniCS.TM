...
CREATE UNIQUE INDEX CLIENT_ID ON CLIENT (
    CODE_CLIENT
);

CREATE INDEX CLIENT_phone ON CLIENT (
    PHONE
);


CREATE UNIQUE INDEX CLIENT_BARCODE ON CLIENT (
    BARCODE
);
...
CREATE UNIQUE INDEX TYPE_DISCOUNT_ID ON TYPE_DISCOUNT (
    TYPE_DISCOUNT
);
...
CREATE UNIQUE INDEX PRICE_ID ON PRICE (
    CODE_DEALER,CODE_WARES
);
