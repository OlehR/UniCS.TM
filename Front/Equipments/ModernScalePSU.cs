...
{
    public class ModernScalePSU : IBarcodeScanner, IBaseDevice, IDisposable, IUserScales
    {
        ...
        private readonly ILogger<ModernScalePSU> _logger;
        ...
        private int _baudRate => int.Parse(this._configuration["Devices:ModernScalePSU:BaudRate"] ?? "9600");
        ...
        public ModernScalePSU(
          IConfiguration configuration,
          ILogger<ModernScalePSU> logger)
        {
            if (logger != null)
                logger.LogDebug("ModernScalePSU CTOR");
        ...
        public eDeviceConnectionStatus Init()
        {
            lock (this._locker)
            {
                ...
                {
                    ILogger<ModernScalePSU> logger = this._logger;
                    if (logger != null)
