...
namespace Front.Equipments.pRRO_SG
{
    ...
    public class pRRO_SG:Rro
    {
        ...
        public pRRO_SG(Equipment pEquipment, IConfiguration pConfiguration, Microsoft.Extensions.Logging.ILoggerFactory pLoggerFactory = null, Action<StatusEquipment> pActionStatus = null) : 
                        base(pEquipment, pConfiguration,eModelEquipment.pRRO_SG, pLoggerFactory, pActionStatus) 
        {
